...
class Settings(BaseSettings):
    ...
    openai_api_key: str = ""
    turning_test_openai_model: str = "gpt-4.1-nano"
    pangram_api_key: str = ""
    pangram_api_base_url: str = "https://text.external-api.pangram.com"
    # Pangram's documented fast model identifier; override only when the account uses another model.
    pangram_model: str = "pangram-4"
